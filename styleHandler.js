...
if(platform == "Desktop")
{
    background.style = "margin-top: 40px;margin-left: auto;margin-right: auto; display: block; opacity: 100%; max-width: 40%; max-height: fit-content;background-color: transparent;";
